...
double sensorDiametro=0, diametro=0;            //Sensor IR que mide distancia al rollo para estimar su diámetro y cuanto uso lleva
...
float sensorLinea; //para almacenar la lectura análoga del sensor de línea
