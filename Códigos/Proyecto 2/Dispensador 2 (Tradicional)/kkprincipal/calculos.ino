...
void calculo() {
  ...
  while (flag_rolling == 1) {
    ...
    vibra=MeasureDigitalN(SAMPLES, IN_VIBRACION);
    if (vibra==1) {
    ...
    if (fin_halada) {
      ...
      sensorDiametro2 = leerLaser();//Aqui se hace la lectura de la distancia TODO: ver si es necesario un filtro  
      escribe_fin_halada();
    }
  } 
}
...
void escribe_fin_halada(){
  ...
  sensorDiametro = leerLaser(); //Aqui se hace la lectura de la distancia TODO: ver si es necesario un filtro  
